...
public class MahasiswaController {
    ...
    private void saveData() {
        ...
        if (!isNumeric(view.txtAngkatan.getText())) {
            JOptionPane.showMessageDialog(view, "Angkatan harus berupa angka!", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        angkatan = Integer.parseInt(view.txtAngkatan.getText());
    ...
    // Fungsi helper untuk memvalidasi input numerik
